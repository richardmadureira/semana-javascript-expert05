...
describe('#Routes test suite', () => {
    ...
    describe('#handler', () => {
        ...
        test('given ant inexistent route it should choose default route', async () => {
            const routes = new Routes();
            const params = {
                ...defaultParams
            };
    ...
    describe("#get", () => {
        test('given method GET it should list all files downloaded', async () => {
            ...
            const filesStatusesMock = [
                {
                    size: "198 MB",
                    lastModified: '2021-09-06T22:19:33.961Z',
            ...
            // expect(route.fileHelper.getFileStatus).toHaveBeenCalledWith()
        });
    })
})